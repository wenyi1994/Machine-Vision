...
[coloring.m](https://github.com/wenyi1994/Machine-Vision/blob/master/Assignment4/coloring.m) is a function that can fill a image generated by [CCL.m](https://github.com/wenyi1994/Machine-Vision/blob/master/Assignment4/ccl.m), legal input of used colors can be numbers(`3` `5` or any positive integer), colormaps(`[1,0,0; 0,1,0; 0,0,1]`) or image(by MATLAB loaded image varible like `I = imread(stack.png)`)
